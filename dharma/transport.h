#ifndef dharma_api_TRANSPORT_H
#define dharma_api_TRANSPORT_H
...
#define DHARMA_POLL(tport, msgtype) tport->poll<msgtype>(__FILE__, __LINE__, #msgtype)
#define DHARMA_POLL_TIME(tport, msgtype, to) tport->poll<msgtype>(to, __FILE__, __LINE__, #msgtype)
