...
RegisterDebugSlot(dharma_allreduce, "print all debug output associated with allreduce collectives in the dharma framework");
...
wilke_allreduce_actor::init_dag()
{
  ...
  debug_printf(dharma_collective | dharma_allreduce,
