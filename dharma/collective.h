#ifndef dharma_api_COLLECTIVE_H
#define dharma_api_COLLECTIVE_H

#include <dharma/timeout.h>
#include <dharma/collective_message_fwd.h>
#include <dharma/transport_fwd.h>
#include <dharma/domain_fwd.h>
#include <dharma/collective_actor_fwd.h>
#include <dharma/comm_functions.h>
#include <sprockit/factories/factory.h>
#include <sprockit/debug.h>

DeclareDebugSlot(dharma_collective)
DeclareDebugSlot(dharma_vote)
DeclareDebugSlot(dharma_collective_sendrecv)
DeclareDebugSlot(dharma_collective_init)
DeclareDebugSlot(dharma_collective_round)
