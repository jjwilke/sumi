...
DeclareDebugSlot(dharma_collective_buffer)
RegisterDebugSlot(dharma_collective_buffer)
...
#define do_debug_print(...) if (sprockit::debug::slot_active(sprockit::dbg::dharma_collective_buffer)) debug_print(__VA_ARGS__)
...
collective_actor::cancel_ping(int dense_rank)
{
  ...
  if (refcount == 0){
    ...
    debug_printf(dharma_collective | dharma_ping,
...
collective_actor::dense_to_global_dst(int dense_dst)
{
  ...
  debug_printf(dharma_collective |  dharma_collective_sendrecv,
...
{
  debug_printf(dharma_collective,
...
dag_collective_actor::send_eager_message(action* ac)
{
  ...
  debug_printf(dharma_collective | dharma_collective_sendrecv | dharma_failure,
...
{
  debug_printf(dharma_collective | dharma_collective_init,
...
dag_collective_actor::data_recved(
  ...
  void* recvd_buffer)
{
   debug_printf(dharma_collective | dharma_collective_round | dharma_collective_sendrecv,
...
{
  debug_printf(dharma_collective | dharma_collective_sendrecv | dharma_collective_round,
