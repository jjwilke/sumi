...
RegisterDebugSlot(dharma_allgather,
  "print all debug output associated with allgather collectives in the dharma framework");
...
bruck_actor::init_dag()
{
  ...
  debug_printf(dharma_collective | dharma_allgather,
