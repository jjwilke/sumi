...
RegisterDebugSlot(dharma_ping,
  "print all debug output associated with ping/timeout operations in the dharma framework");
RegisterDebugSlot(dharma_failure,
  "print all the debug output associated with all node failures detected by the dharma framework");

ImplementFactory(dharma::activity_monitor);
