...
RegisterDebugSlot(dharma_collective_init,
 "print all debug output for collectives performed within the dharma framework");
RegisterDebugSlot(dharma_collective,
 "print all debug output for collectives performed within the dharma framework");
RegisterDebugSlot(dharma_collective_sendrecv,
 "print all debug output for individual send/recv operations done by a dharma collective");
RegisterDebugSlot(dharma_collective_round,
 "print all debug output for configuring/running collectives like allreduce based on round-by-round communication");
RegisterDebugSlot(dharma_vote,
 "print all debug output for fault-tolerant voting collectives within the dharma framework");

ImplementFactory(dharma::dag_collective)
...
collective::init(type_t ty, transport *api, domain *dom, int tag, int context)
{
  ...
  debug_printf(dharma_collective | dharma_vote,
